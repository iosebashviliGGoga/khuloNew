...
function KomisiebisSkhdomisOqmebi() {
  ...
  useEffect(() => {
    ...
    return (
        ...
        <span>საკრებულოს კომისიების სხდომის ოქმები</span>
        ...
        <Helmet><title>საკრებულოს კომისიების სხდომის ოქმები</title></Helmet>
    ...
    return [...Object.entries(item[1])].reverse().filter(news => news[1].geo.pdf_title.includes(search)).map((gank,index) =>{
     if(gank[1].geo.legal_acts_menu==('საკრებულოს კომისიების სხდომის ოქმები'))
...
export default KomisiebisSkhdomisOqmebi