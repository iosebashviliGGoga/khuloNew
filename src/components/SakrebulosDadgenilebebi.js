...
function SakrebulosDadgenilebebi() {
  ...
  useEffect(() => {
    ...
    fetch(link)
      ...
      .then((data) => {
        ...
        let oqmebi = data['საკრებულოს დადგენილებები']
        ...
        setNews(data['საკრებულოს დადგენილებები'])
    ...
    >
      ...
      <div className="news-container margin-280px">
        <header>
          ...
          <span>{menuName[1] ? (language == 1 ? 'საკრებულოს დადგენილებები' : "ASSEMBLY RESOLUTIONS") : ""}</span>
        </header>
        <div>
          ...
          <div className='sakrebulo-landing'>
            <div className="landing-container">
              <div className="sajaroInfo ">
                ...
                <Helmet><title>{menuName[1] ? (language == 1 ? 'საკრებულოს დადგენილებები' : "ASSEMBLY RESOLUTIONS") : ""}</title></Helmet>
...
export default SakrebulosDadgenilebebi